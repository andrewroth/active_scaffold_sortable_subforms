...
You'll need at least ActiveScaffold 1.1.1 to use this, and rails 2.0.  This demo is set to use 2.0.2.  "gem install -v=2.0.2 rails" if you don't have it already.
